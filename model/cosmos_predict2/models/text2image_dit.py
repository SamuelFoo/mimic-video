...
class MiniTrainDIT(WeightTrainingStat):
    ...
    def forward(
        ...
        return_hidden_states = return_only_hidden_states_up_to is not None
        ...
        for i, block in enumerate(blocks, 1):
            ...
            x_B_T_H_W_D: torch.Tensor = block(
                x_B_T_H_W_D,
                t_embedding_B_T_D,
                crossattn_emb,
                **block_kwargs,
        ...
        if return_hidden_states:
            return x_B_C_Tt_Hp_Wp, hidden_states
    ...
    def disable_context_parallel(self) -> None:
        if not self._is_context_parallel_enabled:
            return
